...
/***/ "./node_modules/angular-base64-upload/index.js":
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__("./node_modules/angular-base64-upload/src/angular-base64-upload.js");
...
__webpack_require__("./node_modules/angular-ui-bootstrap/dist/ui-bootstrap-tpls.js");
...
var app = angular.module('app', ['ui.bootstrap', 'controllers.app', 'controllers.categoryIndex', 'controllers.categoryEdit', 'controllers.attributeIndex', 'controllers.productIndex', 'controllers.productEdit', 'controllers.productCreate', 'controllers.supplierIndex', 'controllers.supplierCreate', 'controllers.supplierEdit', 'controllers.categoryProductCreate', 'controllers.productSupplier', 'controllers.productSaleprice', 'controllers.transportFeeIndex', 'controllers.productSupplierIndex', 'directives.format', 'directives.currencyInput', 'directives.select2']);
...
__webpack_require__("./resources/assets/js/controllers/categoryIndex.controller.js");
__webpack_require__("./resources/assets/js/controllers/categoryEdit.controller.js");
__webpack_require__("./resources/assets/js/controllers/attributeIndex.controller.js");
__webpack_require__("./resources/assets/js/controllers/productIndex.controller.js");
...
__webpack_require__("./resources/assets/js/controllers/supplierEdit.controller.js");
...
__webpack_require__("./resources/assets/js/controllers/productSupplierIndex.controller.js");

__webpack_require__("./resources/assets/js/directives/fileread.directive.js");
__webpack_require__("./resources/assets/js/directives/select2.directive.js");
__webpack_require__("./resources/assets/js/directives/format.directive.js");
__webpack_require__("./resources/assets/js/directives/currencyInput.directive.js");
...
/***/ "./resources/assets/js/controllers/attributeIndex.controller.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/controllers/categoryEdit.controller.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/controllers/categoryIndex.controller.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/controllers/categoryProductCreate.controller.js":
/***/ (function(module, exports) {

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };

angular.module('controllers.categoryProductCreate', []).controller('CategoryProductCreateController', CategoryProductCreateController);
...
function ProductEditController($scope, $http, $window) {
    ...
    $scope.getProduct = function () {
        $http.get('/products/' + PRODUCT_ID).then(function (response) {
    ...
    $scope.update = function () {
        ...
        $http.put('/products/' + PRODUCT_ID, $scope.editProductForm).then(function (response) {
    ...
    $scope.populateProductAttributeForm = function () {
        ...
        _.each($scope.product.category.attributes, function (attribute) {
            if (!productAttributes || typeof productAttributes[attribute.slug] == 'undefined') {
                ...
                $scope.editProductAttributeForm.values[attribute.slug] = attribute.frontend_input == 'multiselect' ? productAttributes[attribute.slug] : '' + productAttributes[attribute.slug];
            }
        });
    };
    ...
    $scope.updateProductAttribute = function () {
        ...
        $http.put('/products/' + PRODUCT_ID + '/attributes', $scope.editProductAttributeForm).then(function (response) {
...
/***/ "./resources/assets/js/controllers/productIndex.controller.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/controllers/productSupplier.controller.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/controllers/productSupplierIndex.controller.js":
/***/ (function(module, exports) {
...
function ProductSupplierIndexController($scope, $http, $window, $filter) {
    ...
    $scope.getProductsList = function () {
        ...
        $http.get('/api/products/search?q=' + $scope.productsListForm.q + '&page=' + $scope.productsListForm.page + '&limit=' + $scope.productsListForm.limit).then(function (response) {
    ...
    $scope.getSuppliersList = function () {
        $http.get('/api/suppliers/search?q=' + $scope.suppliersListForm.q + '&page=' + $scope.suppliersListForm.page + '&limit=' + $scope.suppliersListForm.limit).then(function (response) {
...
/***/ "./resources/assets/js/controllers/supplierEdit.controller.js":
/***/ (function(module, exports) {

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };

angular.module('controllers.supplierEdit', []).controller('SupplierEditController', SupplierEditController);
...
function SupplierEditController($scope, $http, $window) {
    ...
    $scope.getSupplier = function () {
        $http.get('/suppliers/' + SUPPLIER_ID).then(function (response) {
    ...
    $scope.update = function () {
        ...
        $http.put('/suppliers/' + SUPPLIER_ID, $scope.editSupplierForm).then(function (response) {
...
/***/ "./resources/assets/js/controllers/transportFeeIndex.controller.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/directives/currencyInput.directive.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/directives/fileread.directive.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/directives/format.directive.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/directives/select2.directive.js":
/***/ (function(module, exports) {
