...
angular.module('controllers.productEdit', []).controller('ProductEditController', ProductEditController).directive('select2', select2).directive('datatable', datatable);
...
function ProductEditController($scope, $http, $window) {
    ...
    $scope.columnDefs = [{ "mDataProp": "category", "aTargets": [0] }, { "mDataProp": "name", "aTargets": [1] }, { "mDataProp": "price", "aTargets": [2] }];
