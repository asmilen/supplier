    ...
    <div class="row" ng-if="productIsLoaded">
        <div class="col-xs-12">
            <div class="alert alert-danger" ng-show="productForm.errors.length > 0">
                Có lỗi xảy ra trong quá trình cập nhật:<br><br>
                <ul>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="file" class="form-control" name="image" placeholder="Image"
                               fileread="productForm.image" accept="image/*">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        @foreach (config('teko.stores') as $k => $v)
                            <div class="checkbox">
                                <label>
                                    <input name="form-field-checkbox" type="checkbox" class="ace" ng-model="productForm.channel[{{ $k }}]" ng-true-value="true" ng-false-value="false" value="{{ $k }}" />
