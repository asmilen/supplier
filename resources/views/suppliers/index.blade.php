    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                ...
                <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal"><i
                            class="ace-icon fa fa-plus" aria-hidden="true"></i>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" role="form" id="supplier_form"
                                      action="{{ url('suppliers/map-suppliers') }}" method="POST"
                                            ...
                                            <select name="product_id" class="js-example-basic-single"
                                                ...
                                                @foreach($products as $key => $value)
                                                    <option value="{{  $value->id }}"
                                                            style="font-size: 14px;">{{ $value->sku }}
                                                        - {{  $value->name }}</option>
                                                @endforeach
                                            </select>
                                            <p style="color:red;text-align: left;font-size:14px;"
                                               id="product_id">{{$errors->first('product_id')}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p style="color:red;text-align: left;font-size:14px;"
                                               id="supplier_id">{{$errors->first('supplier_id')}}</p>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-left">Tình trạng nhà cung
                                            cấp</label>
                                        <div class="col-sm-9">
                                            ...
                                            <p style="color:red;text-align: left;font-size:14px;"
                                               id="status">{{$errors->first('status')}}</p>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-left">Tình trạng sản
                                            phẩm</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" class="form-control" name="import_price"
                                                   placeholder="Nhập giá">
                                            <p style="color:red;text-align: left; font-size: 14px"
                                               id="import_price">{{$errors->first('import_price')}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p style="color:red;text-align: left; font-size: 14px"
                                               id="vat">{{$errors->first('vat')}}</p>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-left">Giá bán khuyến
                                            nghị</label>
                                        <div class="col-sm-9">
                                            <input type="number" min="0" class="form-control" name="price_recommend"
                                                   placeholder="Nhập giá bán khuyến nghị">
                                            <p style="color:red;text-align: left; font-size: 14px"
                                               id="price_recommend">{{$errors->first('price_recommend')}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <p style="color:red;text-align: left; font-size: 14px"
                                               id="quantity">{{$errors->first('quantity')}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="description"
                                                      id="_description"></textarea>
                                            <p style="color:red;text-align: left; font-size: 14px"
                                               id="description">{{$errors->first('description')}}</p>
                                        </div>
                    ...
                    <div class="widget-body">
                        <div class="widget-main" style="overflow:hidden;">
                            <div style="float: left; margin-right: 15px">
                                <form class="form-inline" id="export-form" action="{{ url('suppliers/exportExcel') }}"
                                      method="post">
                            ...
                            <div style="float: left; margin-right: 15px">
                                <form class="form-inline" action="{{ url('suppliers/importExcel') }}" method="post"
                                      enctype="multipart/form-data">
                                    {{ csrf_field() }}
                ...
                <div class="modal fade" id="myModalProduct" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" role="form" id="supplier_form" action="" method="POST"
                                      enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    ...
                                    <table id="tableproducts"
                                        ...
                                        @foreach($products as $key => $value)
                                            <tr>
                                                <td><input type="radio" class="radio" value="{{ $value->id }}"
                                                           name="product_id"></td>
                                                <td>{{ $value->id }}</td>
                                                <td>{{ $value->name }}</td>
                                                <td>{{ $value->sku }}</td>
                        ...
                        <th style="width: 20%">
                            <div class="col-sm-12 no-padding-left no-padding-right">
                                <div class="form-group" style="width: 100%">
                                    <div ng-controller="ProductSupplierController">
                                        <select name="db_category_name"
                                                ng-model="productForm.category_id" ng-change="refreshData()"
                                                placeholder="-- Chọn danh mục --" ng-disabled="disabled" select2>
                                            <option value=""></option>
